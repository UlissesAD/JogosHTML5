...
function start() { // Inicio da função start()
    ...
    $("#fundoGame").append('<div id="volume" class="volume" onclick="cvol()"></div>')
    ...
    function music() {
        ...
        if (volumeOp == 0) {
            $("#volume").css("background-image", "url(jogo1/imgs/volume0.png)");
            musica.play();
        }
        if (volumeOp == 1) {
            $("#volume").css("background-image", "url(jogo1/imgs/Volume1.png)");
            musica.pause();
        }
    }
